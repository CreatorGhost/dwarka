...
export default function Home() {
  ...
  function completeStory() {
    ...
    setStoryOpen(false);
    window.location.assign("/game/chapter-1?entry=cinematic");
  }
  function startPrimary() { if (action.kind === "story") setStoryOpen(true); else window.location.assign(action.href); }
  ...
  return (
    <main className="title-page" lang={locale}>
      ...
      {storyOpen && profile ? <ChapterZeroCinematic copy={copy} locale={locale} profile={profile} chapterTitle={menuCopy.subtitle} onSaveSetting={saveSetting} onComplete={completeStory} /> : null}
