    ...
    <main className="title-page" lang={locale}>
      <section className="title-screen" aria-labelledby="page-title">
        <div className="title-art" aria-hidden="true">
          <Image src="/brand/title-key-art.webp" alt="" fill sizes="100vw" priority unoptimized />
        </div>
        ...
        <div className="title-lockup">
          <h1 className="title-wordmark" id="page-title">
            <span className="title-wordmark-main">Dwarka</span>
            <span className="title-wordmark-sub">The Lost City</span>
          </h1>
          <p className="title-chapter"><span>{copy.home.decisionChapter}</span><b>{menuCopy.subtitle}</b></p>
          <p className={`title-status${profile?.progressSummary?.chapterComplete ? " is-complete" : ""}`} aria-live="polite">{titleStatus}</p>
