...
const outputDir = new URL("../tests/browser-artifacts/env-revamp-checkpoint/", import.meta.url);
const pageUrl =
...
if (label === "door") await evaluate("window.__DWARKA_QA__?.setView(-0.42, -0.04)");
if (label === "bow") {
